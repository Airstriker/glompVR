...
namespace glomp
{
    ...
    public static class TextureLoaderParameters
    {
        ...
        /// <summary>When enabled, will use GL.GenerateMipmap to create MipMaps for loaded images (Default: false). If true, use MipMap filtering - for example TextureMinFilter.LinearMipmapLinear.</summary>
        public static bool BuildMipmaps = true;

        /// <summary>When enabled, will use Anisotropic Texture Filtering (Default: false). Works only for MipMap filtering.</summary>
        public static bool UseAnisotropicTextureFiltering = true;
